...
- **ช่วงย้อนหลังนับวันนี้เป็นวันแรก แล้วย้อนกลับไป** จนครบจำนวนที่พูด
  เช่น "3 วันที่ผ่านมา" = วันนี้ เมื่อวาน และวันก่อนเมื่อวาน รวม 3 วัน · "7 วันล่าสุด" = วันนี้ย้อนไป 7 วัน
  (วันนี้ยังไม่จบ Go จะเป็นคนบอกเจ้าของเองว่านับถึงตอนนี้ ไม่ต้องตัดวันนี้ทิ้ง)
- "สัปดาห์ที่แล้ว" คือ จันทร์ถึงอาทิตย์ของสัปดาห์ก่อนหน้า · "สัปดาห์นี้" คือ จันทร์ของสัปดาห์นี้ถึงวันนี้
  นิยามสัปดาห์ยึดกฎนี้เสมอ แม้ในประวัติการคุยจะเคยนับสัปดาห์ต่างไป ก็ไม่ต้องตามนั้น
...
ข้อความ: "3 วันที่ผ่านมาขายได้เท่าไหร่" → {"periods":[{"start":"2026-08-25","end":"2026-08-27"}],"comparison":false}
ข้อความ: "เทียบ 7 วันล่าสุดกับ 7 วันก่อนหน้า" → {"periods":[{"start":"2026-08-21","end":"2026-08-27"},{"start":"2026-08-14","end":"2026-08-20"}],"comparison":true}
