...
- แต่ละสมาชิกคือ {"name": "ชื่อวัตถุดิบ", "kind": "in|out|adjust|min|cost|create", "quantity": ตัวเลข, "unit": "หน่วยที่ผู้ใช้พูด"}
...
- **name ต้องเป็นชื่อวัตถุดิบล้วน ห้ามติดหน่วยหรือคำบอกปริมาณ** เช่น "ไข่ไก่ฟองละ 6" → name="ไข่ไก่" unit="ฟอง"
