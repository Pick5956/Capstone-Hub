...
var joyboyToolGuide = map[AIToolName]string{
	...
	AIToolGetSalesForPeriod: "ยอดขายรวมทั้งร้าน (ไม่แยกเมนู) ของช่วงเวลาที่ผู้ใช้ระบุชื่อมา " +
		"ทั้งวันนี้ เมื่อวาน 7 วันล่าสุด สัปดาห์ก่อน วันเจาะจง เดือน (เดือนนี้ เดือนที่แล้ว เดือนกรกฎาคม กรกฎาคม 2568) " +
		"ปี (ปีนี้ ปีที่แล้ว ปี 2568) และการเทียบเดือนต่อเดือนหรือปีต่อปี " +
		"ใช้ตอบเมื่อถามยอดขาย/รายได้รวมของช่วงที่ระบุ เช่น ยอดขายเดือนกรกฎาคม ยอดเดือนนี้เท่าไหร่ เทียบยอดเดือนนี้กับเดือนก่อน " +
