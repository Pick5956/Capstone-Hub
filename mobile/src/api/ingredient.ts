...
import type { AdjustStockInput, Ingredient, IngredientCategory, IngredientInput, IngredientTransaction } from '@/src/types/ingredient';
...
export const updateIngredient = (id: number, data: IngredientInput) => apiRequest<Ingredient>(`/api/v1/ingredients/${id}`, { method: 'PUT', body: JSON.stringify(data) });
