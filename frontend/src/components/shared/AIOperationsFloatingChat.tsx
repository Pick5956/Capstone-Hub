    ...
    <>
      ...
      >
        ...
        <div className="relative isolate flex h-full w-full shrink-0 rounded-md">
          ...
          >
            <div className="flex items-end gap-2 rounded-[1.5rem] border border-gray-200 bg-white p-1.5 shadow-sm transition focus-within:border-orange-300 dark:border-gray-800 dark:bg-gray-900">
              <AIInputTools
                tools={["scan"]}
                language={language}
                disabled={loading || actionConfirming || actionCancelling}
