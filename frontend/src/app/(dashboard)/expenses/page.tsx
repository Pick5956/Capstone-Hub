  ...
  return (
    ...
    >
      ...
      <div className="mb-3 flex flex-wrap items-center gap-2">
        ...
        {canEdit ? (
          <button type="button" onClick={openAdd} className="ui-press inline-flex h-9 items-center gap-2 rounded-md bg-gray-900 px-3 text-[12px] font-semibold text-white hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200 print:hidden">
