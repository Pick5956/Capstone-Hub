          ...
          <form onSubmit={submit} className="space-y-4 p-4">
            <label className="block">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-md border border-gray-200 bg-white px-3 py-2 text-[13px] outline-none transition-colors focus:border-orange-500 dark:border-gray-700 dark:bg-gray-900"
              />
            </label>
